...
public class Dec15 extends AOCParent {
    ...
    public void part1() {
        ...
        Coordinate robot = warehouse.findValue(ElementP1.ROBOT);
    ...
    private Long computeScoreP1(Grid<ElementP1> warehouse) {
        List<Coordinate> boxes = warehouse.findValues(ElementP1.BOX);
    ...
    public void part2() {
        ...
        Coordinate robot = warehouse.findValue(ElementP2.ROBOT);
        ...
        List<Coordinate> boxLocations = warehouse.findValues(ElementP2.BOX_LEFT);
